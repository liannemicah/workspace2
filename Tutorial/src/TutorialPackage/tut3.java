...
public class tut3 { 
	...
	public static void main(String[] args) {
        Rectangle b1 = new Rectangle(60,10,40,30);
        Rectangle b2 = new Rectangle(40,40,40,30);
        Rectangle b3 = new Rectangle(80,40,40,30);
        Rectangle b4 = new Rectangle(20,70,40,30);
        Rectangle b5 = new Rectangle(60,70,40,30);
        Rectangle b6 = new Rectangle(100,70,40,30);
        
        b1.setColor(new Color(125,125,255));
        b.setColor(Color);
                b.setColor(Color);
        b.setColor(Color);
        b.setColor(Color);
